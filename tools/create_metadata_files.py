...
if __name__ == '__main__':
  ...
  parser.add_argument('-s','--source_folder', type=str, default="/home/jberezow/Projects/webcomic/src/assets/comics/images", help='Folder to load metadata files from')
  parser.add_argument('-t','--target_folder', type=str, default="/home/jberezow/Projects/webcomic/src/assets/metadata/images", help='Folder to save metadata files to')
